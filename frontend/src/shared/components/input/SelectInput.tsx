  ...
  return (
    ...
    >
      ...
      <span className="select-option__body">
        ...
        {opt.description && (
          <span className="select-option__desc">{opt.description}</span>
        )}
      </span>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── 드롭다운 패널 ── */}
        {open && (
          <div className={`select-dropdown ${dropUp ? 'select-dropdown--above' : 'select-dropdown--below'}`}>
