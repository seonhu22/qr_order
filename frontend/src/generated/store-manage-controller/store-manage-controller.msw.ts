...
export const getGetTableGuiResponseMock = (): TableGuiResponse[] => (Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({sysId: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), tableName: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), tableNum: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), tableQty: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), height: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), width: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), tableType: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), objectType: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), xcoordinate: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), ycoordinate: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined])})))
