...
export const getChangePasswordMockHandler = (overrideResponse?: CommonResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<CommonResponse> | CommonResponse), options?: RequestHandlerOptions) => {
  return http.post('*/api/popup/change_password/change', async (info) => {await delay(1000);
...
export const getPopupControllerMock = () => [
