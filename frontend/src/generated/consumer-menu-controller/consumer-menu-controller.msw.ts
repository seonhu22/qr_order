...
export const getGetConsumerMenuDetailResponseMock = (overrideResponse: Partial< ConsumerMenuDetailEnvelope > = {}): ConsumerMenuDetailEnvelope => ({success: faker.datatype.boolean(), message: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), error: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), data: {body: {menuSysId: faker.string.alpha({length: {min: 10, max: 20}}), categorySysId: faker.string.alpha({length: {min: 10, max: 20}}), categoryName: faker.string.alpha({length: {min: 10, max: 20}}), menuName: faker.string.alpha({length: {min: 10, max: 20}}), menuPrice: faker.number.int({min: undefined, max: undefined}), menuDescription: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), fileSysId: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), menuTag: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), optionUseYn: faker.helpers.arrayElement(['Y','N'] as const), soldOutYn: faker.helpers.arrayElement(['Y','N'] as const), optionGroupList: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({optionGroupSysId: faker.string.alpha({length: {min: 10, max: 20}}), groupName: faker.string.alpha({length: {min: 10, max: 20}}), requiredYn: faker.helpers.arrayElement(['Y','N'] as const), selectionType: faker.helpers.arrayElement(['01','02','03'] as const), optionList: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({menuOptionSysId: faker.string.alpha({length: {min: 10, max: 20}}), menuOptionName: faker.string.alpha({length: {min: 10, max: 20}}), menuOptionPrice: faker.number.int({min: undefined, max: undefined}), menuOptionDescription: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), maximumNum: faker.number.int({min: undefined, max: undefined}), defaultYn: faker.helpers.arrayElement(['Y','N'] as const), soldOutYn: faker.helpers.arrayElement(['Y','N'] as const)}))}))}}, ...overrideResponse})
