...
- [1. 문서 목적](#1-문서-목적)
- [2. 이 가이드를 읽는 방법](#2-이-가이드를-읽는-방법)
- [3. 서버 상태와 UI 상태를 먼저 구분하기](#3-서버-상태와-ui-상태를-먼저-구분하기)
- [4. TanStack Query가 해결하려는 문제](#4-tanstack-query가-해결하려는-문제)
- [5. 왜 MSW를 먼저 준비하는가](#5-왜-msw를-먼저-준비하는가)
- [6. MSW 기초 개념](#6-msw-기초-개념)
- [7. 1단계 커밋: MSW 핸들러로 응답 먼저 정의하기](#7-1단계-커밋-msw-핸들러로-응답-먼저-정의하기)
- [8. Query란 무엇인가](#8-query란-무엇인가)
- [9. QueryClient란 무엇인가](#9-queryclient란-무엇인가)
- [10. 2단계 커밋: `queryClient` 생성하기](#10-2단계-커밋-queryclient-생성하기)
- [11. QueryClientProvider란 무엇인가](#11-queryclientprovider란-무엇인가)
- [12. 3단계 커밋: App 최상단에 Provider 연결하기](#12-3단계-커밋-app-최상단에-provider-연결하기)
- [13. 왜 API 함수를 먼저 분리하는가](#13-왜-api-함수를-먼저-분리하는가)
- [14. 4단계 커밋: 사업장 조회 API 함수 만들기](#14-4단계-커밋-사업장-조회-api-함수-만들기)
- [15. `useQuery`를 처음 이해하기](#15-usequery를-처음-이해하기)
- [16. 5단계 커밋: 첫 TanStack Query 컴포넌트 만들기](#16-5단계-커밋-첫-tanstack-query-컴포넌트-만들기)
- [17. 6단계 커밋: 페이지에 연결하기](#17-6단계-커밋-페이지에-연결하기)
- [18. 현재 코드가 실제로 동작하는 순서](#18-현재-코드가-실제로-동작하는-순서)
- [19. 캐시는 어떻게 이해하면 되는가](#19-캐시는-어떻게-이해하면-되는가)
- [20. 초보자가 처음 TanStack Query를 쓸 때 지켜야 할 규칙](#20-초보자가-처음-tanstack-query를-쓸-때-지켜야-할-규칙)
- [21. 다음 단계는 무엇인가](#21-다음-단계는-무엇인가)
- [22. 다음 단계: useMutation 기초 이해](#22-다음-단계-usemutation-기초-이해)
- [23. 커밋 순서 요약](#23-커밋-순서-요약)
- [24. 결론](#24-결론)
